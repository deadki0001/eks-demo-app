      ...
      {desktop && !isAbout ? (
        <div className="desktop-content">
          <div style={{overflow:'hidden',display:'flex',flexDirection:'column'}}>
            <Routes>
              <Route path="/" element={<Home payments={payments} loading={loading} onSend={() => setSheet(true)} desktop={true} />} />
          ...
          <div className="desktop-right-panel">
            ...
            <button className="send-btn" style={{flexShrink:0,marginTop:'auto'}} onClick={() => setSheet(true)}>
        ...
        <div className="mobile-content">
          <Routes>
            <Route path="/" element={<Home payments={payments} loading={loading} onSend={() => setSheet(true)} desktop={false} />} />
            <Route path="/analytics" element={<Analytics payments={payments} />} />
            <Route path="/beneficiaries" element={<Beneficiaries apiUrl={API_URL} onSend={() => setSheet(true)} />} />
            <Route path="/instant-money" element={<InstantMoney apiUrl={API_URL} />} />
          </Routes>
